        ...
        <div className="big:hidden opacity-0 small:opacity-100 absolute z-10">
          ...
          >
            ...
            <div className=" small:p-6   small:py-20 small:pl-[72%] text-white font-comforta flex flex-col justify-around small:h-[100%]">
              ...
              >
                <div
                  className="cursor-pointer group text-white text-lg flex flex-start items-center gap-x-[0.2vw] font-comfortaa   hover: duration-250 hover:delay-75  transition-all hover:scale-110 hover:text-orange-600  hover:underline hover:ease-in  "
                ...
                {initiative && (
                  <div className="flex flex-col bg-[#22323A] h-[70%]  ">
                    <div
                      className=" w-full flex items-center justify-center h-full text-center cursor-pointer font-comfortaa text-[15px] font-semibold     hover: duration-250 hover:delay-75  transition-all  hover:bg-orange-600   hover:ease-in   "
                      onClick={() => {
                        navigate("/seminars");
                      }}
                    >
              ...
              >
                ...
                {resources && (
                  <div className="flex flex-col bg-[#22323A] h-[60%]  justify-evenly">
                    <div
                      className=" w-full flex items-center justify-center h-full text-center cursor-pointer font-comfortaa text-[15px] font-semibold     hover: duration-250 hover:delay-75  transition-all  hover:bg-orange-600   hover:ease-in   "
                      onClick={() => {
                        navigate("/Blogs");
              ...
              <div className="flex justify-between pr-12">
                ...
                <a
                  href="https://x.com/EIiitbh?t=Mk8BtvFWoBWOI9zAu7g69w&s=08"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                ...
                <a
                  href="https://www.linkedin.com/company/entrepreneurship-club-iiit-bhagalpur/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
