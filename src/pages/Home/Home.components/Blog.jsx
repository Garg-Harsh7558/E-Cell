...
const Blog = () => {
  // ✅ FIX: Removed unused 'dateTime' state and related useEffect as it was not being used.
  ...
  return (
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 pt-[18vh]">
      ...
      <h2 className='font-blinker font-semibold lg:text-[2vw] md:text-[3vw] text-[30px]'>Recent Blog Posts.</h2>
        ...
        <a href='https://medium.com/@amanpeterson1/campus-to-company-how-to-start-a-startup-in-college-bda9488bb938' target='_blank' rel="noopener noreferrer">
        ...
        <div className='border border-[#D9D9D9]'></div>
          ...
          {/* ✅ FIX: Added rel="noopener noreferrer" for security */}
          <a href='https://medium.com/@ecelliiitbh/stock-market-101-a-beginners-guide-to-investing-1339895e4b28' target='_blank' rel="noopener noreferrer">
